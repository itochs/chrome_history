  ...
  return (
    <div>
      <div id="searchbar">
        ...
        <input type="submit" id="removeAll" value="Remove All"></input>
        <input type="submit" id="seeAll" value="See All"></input>
      </div>
      ...
      <template id="historyTemplate">
        <div className="history">
          ...
          <div className="removeDiv">
            <a>
              <button className="removeButton">Delete</button>
              <input type="checkbox" className="removeCheck" />
            </a>
          </div>
        </div>
      </template>
